...
def main(argv: list[str] | None = None) -> int:
    ...
    if not raw.strip():
        print(
            "SOCRATIC_SPECIFICATION_FORBIDDEN_IDENTIFIERS is empty or unset; skipping identifier gate.",
            file=sys.stderr,
        )
        return 0
    ...
    if not identifiers:
        print(
            "SOCRATIC_SPECIFICATION_FORBIDDEN_IDENTIFIERS contained no usable identifiers (minimum "
